#!/usr/bin/env bash
# Push LastGit main -> GitHub public mirror for edgevector-website.
...
export LASTGIT_MIRROR_CLONE="${LASTGIT_MIRROR_CLONE:-$HOME/.lastgit/mirror-clones/edgevector-website}"
export LASTGIT_MIRROR_REMOTE_URL="${LASTGIT_MIRROR_REMOTE_URL:-https://github.com/EdgeVector/edgevector-website.git}"
export LASTGIT_MIRROR_SOURCE_URL="${LASTGIT_MIRROR_SOURCE_URL:-lastdb:///edgevector-website}"
...
MODE="${1:-}"
exec "$HOME/code/edgevector/lastgit/.lastgit/sync-github-mirror.sh" edgevector-website "$MODE"
